...
/**
 * It will add a listener to the Document that will call the handler function if the user
 * clicks outside of the element that the refObject is attached to
 * @param refObject - React.RefObject<T> that is used to attach a ref to a React element of type T.
